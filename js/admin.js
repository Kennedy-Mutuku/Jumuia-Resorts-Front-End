...
class AdminDashboard {
    ...
    async init() {
        try {
            ...
            this.showAlert('Failed to initialize dashboard. Please refresh.', 'error');
        }
    }
    ...
    async initUserData() {
        ...
        try {
            ...
            if (userDoc.exists) {
                ...
                // Update session
                localStorage.setItem('jumuia_admin_session', JSON.stringify(this.currentUser));
